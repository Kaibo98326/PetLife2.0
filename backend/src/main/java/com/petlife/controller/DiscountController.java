...
public class DiscountController {
	...
	public ResponseEntity<String> saveDiscount(@RequestBody DiscountRequestDTO request) {
		try {
			...
			discountService.saveDiscountWithDetails(request.getDiscount(), request.getCategoryIds(),
					request.getMainProductIds(), request.getAddonProductIds(), request.getAddonCategoryIds(),
