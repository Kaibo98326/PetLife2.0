...
public class AdminGroomerController {
    ...
    @PutMapping
    public ResponseEntity<?> upsertGroomer(@Valid @RequestBody GroomerManageRequest request) {
        return ResponseEntity.ok(groomerService.upsertGroomerWithServices(request));
    }
